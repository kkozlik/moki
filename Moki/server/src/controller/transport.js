...
class transportController extends Controller {
  ...
  static getCharts(req, res, next) {
    super.request(req, res, next, [
      ...
      { index: "logstash*", template: datehistogram_agg_filter_query, params: ["attrs.type", "timebucket"], filter: "*" }], "transport");
  }
  ...
  static getTable(req, res, next) {
    super.requestTable(req, res, next, { index: "logstash*", filter: "*" }, "transport");
  }
}
